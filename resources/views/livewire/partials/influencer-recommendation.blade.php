...
<section class="py-16 bg-zinc-50">
    <div class="container mx-auto px-4">
        ...
        <div class="flex overflow-x-auto gap-6 pb-4 scrollbar-hide">
            ...
            <a href="/product/{{ $index === 0 ? 'vatican-museums-sistine-chapel' : 'tour-' . ($index + 1) }}" class="min-w-[320px] w-[320px] shrink-0 bg-white rounded-lg border border-zinc-200 shadow-sm overflow-hidden hover:shadow-lg transition-shadow">
