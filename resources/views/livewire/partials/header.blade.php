            ...
            <div class="flex-1 flex flex-col justify-center">
                ...
                <div class="flex items-center justify-between py-2">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="text-primary font-medium hover:text-primary/80 text-base transition-colors">Sign Up</a>
                        <a href="{{ route('login') }}" class="text-primary font-medium hover:text-primary/80 text-base transition-colors">Login</a>
                    </div>
                </div>
